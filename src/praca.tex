...
\def\Abstrakt{%
  ...
  The Symbolic analysis library is a library for computing data lineage of
  simple Java applications. Library supports only JDBC and I/O APIs to identify
  the sources and sinks of a data. We proposed some architecture changes
  to the library to be easily extensible by plugins that can add support for
