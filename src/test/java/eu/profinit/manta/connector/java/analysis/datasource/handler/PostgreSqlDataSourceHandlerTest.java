...
public class PostgreSqlDataSourceHandlerTest extends AbstractTest {
    private PostgreSqlDataSourceHandler handler;
    ...
    public void init() {
        ...
        handler = new PostgreSqlDataSourceHandler(classMethodCache);
    }
