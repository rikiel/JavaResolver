...
import static eu.profinit.manta.connector.java.analysis.kafka.handler.KafkaClassWrappers.CONSUMER_CONFIG;
import static org.unitils.reflectionassert.ReflectionAssert.assertReflectionEquals;

public class KafkaConsumerConfigHandlerTest extends AbstractTest {
    private KafkaConsumerConfigHandler handler;
    ...
    public void init() {
        ...
        handler = new KafkaConsumerConfigHandler(classMethodCache);
    }
    ...
    /**
     * @see KafkaConsumerConfigHandler#handleConstructor(MethodCallDescriptionImpl)
     */
    @Nonnull
