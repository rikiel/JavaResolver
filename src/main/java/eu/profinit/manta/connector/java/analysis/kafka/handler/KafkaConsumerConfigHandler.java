...
public class KafkaConsumerConfigHandler implements CallHandler {
    private final CallHandlers handlers;
    private final ClassMethodCache classMethodCache;

    public KafkaConsumerConfigHandler(@Nonnull final ClassMethodCache classMethodCache) {
     ...
     * See org.apache.kafka.clients.consumer.ConsumerConfig#ConsumerConfig(Map, boolean)
     */
    @Nonnull
