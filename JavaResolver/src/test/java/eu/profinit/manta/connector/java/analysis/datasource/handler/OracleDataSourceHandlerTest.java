...
public class OracleDataSourceHandlerTest extends AbstractTest {
    private OracleDataSourceHandler handler;
    ...
    public void init() {
        ...
        handler = new OracleDataSourceHandler(classMethodCache);
    }
